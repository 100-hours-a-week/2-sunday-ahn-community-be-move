document.addEventListener("DOMContentLoaded", async () => {
    ...
    const checkEmailDuplicate = async () => {
        ...
        return await checkDuplicate(`http://3.36.118.177:3000/auth/email`, { email }, emailError);
    };
    ...
    const checkNicknameDuplicate = async () => {
        ...
        return await checkDuplicate(`http://3.36.118.177:3000/auth/nickname`, { nickname }, nicknameError);
    };
    ...
    registButton.addEventListener("click", async (event) => {
        ...
        try {
            ...
            const response = await fetch(`http://3.36.118.177:3000/auth/regist`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
